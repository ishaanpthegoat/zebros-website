...
const WORDMARK_CLASS =
  "whitespace-nowrap text-sm md:text-base font-extrabold tracking-tight uppercase text-foreground/75 dark:text-foreground/80 select-none opacity-60 hover:opacity-100 transition-opacity duration-300";

const BRAND_LOGOS = [
  () => (
    <span className={WORDMARK_CLASS}>
      FIRST<span className="text-primary"> </span>Tech Challenge
    </span>
  ),
  () => (
    <span className={WORDMARK_CLASS}>
  ...
  () => (
    <span className={WORDMARK_CLASS}>
      Cary<span className="text-primary"> · </span>NC
    </span>
  ),
];
